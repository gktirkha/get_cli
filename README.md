> This is just a fork from existing get_cli as it is not working with flutter 3.19.2, I have just upgraded dependencies in pubspec.yaml, [Link to refer](https://github.com/jonataslaw/get_cli/issues/247)
